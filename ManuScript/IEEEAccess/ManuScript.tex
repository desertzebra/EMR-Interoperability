...
%[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{a2.png}}]

\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){schemas}
{Schemas used for knowledge interoperability.\label{figSchema}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){suffixAttribute}
{Suffix attributes.\label{figSuffixAttribute}}
